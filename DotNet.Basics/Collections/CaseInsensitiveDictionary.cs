...
{
    public class CaseInsensitiveDictionary<TK> : IDictionary<string, TK>
    {
        private readonly Dictionary<string, TK> _dictionary = new Dictionary<string, TK>();
        private readonly Func<string, TK> _get;

        public CaseInsensitiveDictionary(WhenKeyNotFound whenKeyNotFound = WhenKeyNotFound.ThrowException)
        {
