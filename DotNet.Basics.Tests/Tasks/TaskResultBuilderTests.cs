...
{
    public class TaskResultBuilderTests
    {
        [Fact]
        public void Ctor_Empty_NoIssues()
        {
            //act
            var result = new TaskResultBuilder().Build();
        ...
        public void Ctor_Append_NewIssuesAreAppended()
        {
            ...
            //act
            var initialResult = new TaskResultBuilder()
                .Add(initialIssueMessage, new IOException())
                .Build();
            ...
            var joinedResult = new TaskResultBuilder(initialResult.Issues).
                Add(appendedIssueMessage, new ArgumentException())
                .Build();
