...
namespace DotNet.Standard.SevenZip
{
    public class SevenZipExe
    {
        ...
        private static Stream _7zaDll => _sevenZipAssembly.GetManifestResourceStream("DotNet.Standard.SevenZip.7za.dll");
        private static Stream _7zaExe => _sevenZipAssembly.GetManifestResourceStream("DotNet.Standard.SevenZip.7za.exe");
        private static Stream _7zxaDll => _sevenZipAssembly.GetManifestResourceStream("DotNet.Standard.SevenZip.7zxa.dll");
