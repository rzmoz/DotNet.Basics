...
{
    public class ArgsProvider(string[] args, Func<IReadOnlyList<string>, IReadOnlyDictionary<string, string>>? argsParser)
    {
        ...
        public string this[string key] => _argsDictionary[key.ToLowerInvariant()];
