...
namespace DotNet.Standard.Tests.Tasks.Pipelines
{
    public class LazyLoadStepTests
    {
        ...
        public void AssertLazyLoadSteps_MissingDirectRegistration_AssertHasIssues()
        {
            ...
            assert.Issues.Single().Message.Should().Be("Failed to load: GenericThatTakesAnotherConcreteClassAsArgStep`1 - Unable to resolve service for type 'DotNet.Standard.Tests.Tasks.Pipelines.PipelineHelpers.ClassThatTakesAnAbstractClassAsCtorParam' while attempting to activate 'DotNet.Standard.Tests.Tasks.Pipelines.PipelineHelpers.GenericThatTakesAnotherConcreteClassAsArgStep`1[System.EventArgs]'.");
